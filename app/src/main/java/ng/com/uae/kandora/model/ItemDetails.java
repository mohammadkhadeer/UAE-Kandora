...
public class ItemDetails {
    ...
    public ItemDetails(String tax, String cat, String categoryID, Description description, ImagePath imagePath, ItemComponents itemComponents, String itemID, Name name, Offer offer,PeopleComment peopleComment, int price, Rate rate)
    {
        this.tax=tax;
        this.cat=cat;
    ...
    public PeopleComment getPeopleComment() {
